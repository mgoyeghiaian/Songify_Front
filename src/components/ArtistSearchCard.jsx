...
const ArtistSearchCard = ({ track }) => {
  ...
  return (
    <div className="flex flex-col w-[430px]  sm:w-[180px] p-4 bg-white/5 bg-opacity-80 backdrop-blur-sm animate-slideup rounded-lg cursor-pointer hover:bg-gray-600" onClick={() => navigate(`/artists/${track?.adamid}`)}>
